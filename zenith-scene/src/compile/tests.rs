...
// ── overflow="autofit": shrink-to-fit title text ─────────────────────────

/// Collect the font_size of every DrawGlyphRun for a given subject color is
/// not feasible; instead helper returns the first DrawGlyphRun font_size.
